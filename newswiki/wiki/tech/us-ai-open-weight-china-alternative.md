...
created: "2026-08-03"
description: "硅谷的一些初创公司正在建立开放AI模型，但由于风投兴趣寥寥，它们的预算捉襟见肘。"
author:
  - "[[Kate Clark]]"
  - "[[Sam Schechner]]"
topics:
...
## 行业动态与挑战
- 开放权重模型允许用户下载参数并在专用硬件上进行微调，提供了比封闭模型更高的灵活性和更低的成本。
- 美国最初由 Meta 的 [[Llama]] 系列引领开放 AI 领域，但中国模型在成本和效率上迅速追赶，迫使美国公司下调高端模型价格以维持竞争力。
