...
- Personal **n8n** skills: **arxiv-digest** (weekly scored arXiv papers → Slack), **china-digest** (Chinese AI news translated), **daily-cto-briefing** (morning prioritization), **MagicMirror [[hubs/llm|LLM]] Summary** (dashboard widget on Samsung Frame TV), and **Frigate** NVR LLM integration for motion-alert interpretation.
